import { SpruceKitClientSession, SpruceKitExtension } from '@spruceid/sprucekit-core/client';
 ...
 */
interface IStorage extends SpruceKitExtension {
  /**
...
export interface IKepler extends IStorage {
  hostOrbit(sprucekitSession?: SpruceKitClientSession): Promise<void>;
  activateSession(
